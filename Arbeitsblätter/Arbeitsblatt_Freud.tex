...
\noindent \textbf{\color{primaryBlue}I. Die anthropologische Ausgangslage: Der Mensch als Triebwesen}
...
\vspace{0.2cm}
\noindent \textbf{\color{primaryBlue}II. Die kulturelle Gegenwehr: Triebverzicht und Liebesgebot}
...
\vspace{0.2cm}
\noindent \textbf{\color{primaryBlue}III. Die seelische Verinnerlichung: Introjektion, Über-Ich und Schuld}
...
\raisebox{-0.85\height}{\includegraphics[width=2.1cm]{Freud.png}} 
\end{tabularx}
\end{tcolorbox}
...
\begin{enumerate}[label=\alph*), leftmargin=0.5cm, itemsep=0.2cm]
    \item \textbf{Verdichtet} Freuds Kulturkritik in \textbf{einem prägnanten Satz}. Berücksichtigt dabei den \textbf{Preis, den der Mensch für die kulturelle Ordnung zahlt}.
...
\vspace{0.1cm}
\begin{tcolorbox}[
    enhanced, colback=white, colframe=primaryBlue!50, boxrule=0.6pt, arc=1mm,
    boxsep=4pt, top=6pt, bottom=6pt, left=8pt, right=8pt
]
\footnotesize\sffamily
\textbf{\color{primaryBlue}Euer Synthese-Satz (Kulturkritik \& Preis der Zivilisation):}\par\vspace{0.15cm}
\noindent\rule{\textwidth}{0.4pt}\\[0.35cm]
\noindent\rule{\textwidth}{0.4pt}
\end{tcolorbox}

\vspace{0.2cm}

% === SCHNELLDENKER: DIDAKTISCHE RESERVE ===
\noindent
\footnotesize \runningMan \, \textbf{\color{primaryBlue}Schnelldenker – Didaktische Reserve (Golden Record Transfer):} \\
Wählt ein Bild aus der \textit{Golden Record} aus. \textbf{Kommentiert} das Bild aus Freuds Perspektive: Was könnte Freud darin über das Verhältnis von menschlicher Natur, Kultur und Unbehagen erkennen?
