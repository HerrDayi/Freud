...
\noindent
\footnotesize \runningMan \, \textbf{\color{primaryBlue}Schnelldenker – Didaktische Reserve (Meme-Transfer):} \\
Stellt Sigmund Freuds These in einem pointierten Meme dar. Nutzt entweder die Comic-Vorlage (Gehirn vs. schlafende Person) oder wählt ein beliebiges Template im Online-Generator (\texttt{imageresizer.com/de/meme-generator}).
