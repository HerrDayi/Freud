...
\hfill
\begin{minipage}[t]{0.38\textwidth}\centering\textbf{\large Anthropologie \& Kultur}\end{minipage}%
\hfill
\begin{minipage}[t]{0.30\textwidth}\raggedleft Datum: \rule{2.5cm}{0.4pt}\end{minipage}
