...
% ==================================================
\begin{frame}[t]{\faSmile \enskip 2. Einstieg: Leistungsdruck \& Das Über-Ich (Meme)}
\vspace{-0.1cm}
...
% ==================================================
\begin{frame}[t]{\faPaintBrush \enskip 6. Vertiefung: Meme-Transfer (Leistungsdruck)}
\vspace{-0.25cm}
...
\begin{columns}[T]
    ...
    \begin{column}{0.50\textwidth}
        ...
        \small
        Formuliert einen Dialog zwischen \textbf{Erholungsbedürfnis} (Ich) und \textbf{Leistungsdruck} (Über-Ich):
        \vspace{0.15cm}
        \begin{itemize}\setlength{\itemsep}{2pt}
            \item[\textbf{1.}] \textbf{Instanzen:} Das Gehirn agiert als unbarmherziger Antreiber (\textit{Über-Ich}).
            \item[\textbf{2.}] \textbf{Konflikt:} Das Chillen / Schlafen prallt auf das schlechte Gewissen, nicht genug getan zu haben.
            \item[\textbf{3.}] \textbf{Pointe:} Freuds These der inneren \textit{„Besatzungsmacht“} auf den Punkt bringen.
        \end{itemize}
        \vspace{0.25cm}
        \footnotesize
...
\begin{itemize}
    ...
    \begin{itemize}\setlength{\itemsep}{6pt}
        \item[\textbf{A)}] \textbf{Leistungsgesellschaft \& Versagensangst:} \\
        Freud postuliert: Das Über-Ich überwacht das Ich wie eine Besatzungsmacht und bestraft selbst kleinste Schwächen mit quälendem Schuldbewusstsein. \\
        $\rightarrow$ \textit{Beurteilt: Ist der heutige Leistungsdruck (Notenstress, Selbstoptimierung) der Beweis dafür, dass wir seelische Gesundheit dem Funktionieren opfern?}
        
        \item[\textbf{B)}] \textbf{Gehlen vs. Freud (Entlastung vs. Dauerüberlastung):} \\
        Gehlen behauptet: Institutionen (Schule, Beruf) schenken uns rettende \textit{Entlastung}. Freud warnt: Sie erzeugen permanentes \textit{Schuldbewusstsein}. \\
        $\rightarrow$ \textit{Entlastet uns die Kultur wirklich – oder überlastet sie uns seelisch? Begründet euer Urteil.}
    \end{itemize}
\end{itemize}
