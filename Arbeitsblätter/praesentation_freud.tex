...
\begin{columns}[T]
    \begin{column}{0.43\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=0.53\textheight, keepaspectratio]{meme_template_clean.jpg}
    \end{column}
    ...
    \begin{column}{0.55\textwidth}
        ...
        \begin{itemize}\setlength{\itemsep}{1pt}
            ...
            \item[\textbf{2.}] \textbf{Konflikt:} Chillen prallt auf das schlechte Gewissen, nicht genug getan zu haben.
            \item[\textbf{3.}] \textbf{Pointe:} Freuds These der inneren \textit{„Besatzungsmacht“} pointiert treffen.
        \end{itemize}
        \vspace{0.15cm}
        \footnotesize
        \textbf{\faUsers \enskip} EA / PA \qquad \textbf{\faClock \enskip} ca.~5--8~Min.
    \end{column}
\end{columns}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}\setlength{\itemsep}{3pt}
        ...
        Freud postuliert: Das Über-Ich überwacht das Ich wie eine Besatzungsmacht und bestraft Erholungswünsche mit permanenter Schuld. \\
        $\rightarrow$ \textit{Beurteilt: Ist der heutige Leistungsdruck (Notenstress, Selbstoptimierung) der Beweis, dass wir seelische Gesundheit dem Funktionieren opfern?}
...
\vspace{0.15cm}
\footnotesize
\textbf{\faUsers \enskip} Partnerarbeit / Think-Pair-Share \qquad \textbf{\faClock \enskip} ca.~5--8~Min.
\end{frame}
